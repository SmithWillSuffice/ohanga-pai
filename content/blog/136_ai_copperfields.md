...
## Mathematical Tasks Are Not Turks

The idea "Ai" (a nonsense term) [FN-1](#fn1) will take away mathematician 
jobs" is the crankiest slice of baloney I've perhaps ever heard. All the 
worse because so many otherwise intelligent people seem to believe it. 

It is all a magic trick of Copperfield dimensions.

Both Copperfields I think, though it has been a while since I read Dicken’s. 
(Will explain in a few paragraphs.)

Today my theme is how machine algorithms designed to mimic human 
language and art are illusions. Unlike Daniel Dennett's ꕯꕒꕯꗞꖀꖡ thesis 
that consciousness is an illusion (it is obviously not! How could a 
philosopher miss that!?🤣) The so-called "Ai" is a giant 
...
regulation of the software. Not all authoritarian structure is 
diabolically evil? Yeah, but it could be less authoritarian. Just 
democratically hand everyone a ration of tokens to use, calibrated to 
respectable electricity usage, so we do not cook the local 
communities where the server farms are located.

When software platform tokens are rationed, I will bet people stop 
...
First level: let's get some decent MMT framing out here: the cause of 
unemployment is the government imposed tax liability, by definition (there 
...
is involved in making the algorithm start running. 

Emergence is not a thing here. Emergence is about our capacity to 
perceive higher level 
abstractions, in the physical realm nothing new physical comes into 
existence. Ergo, consciousness is not a physical emergence phenomenon.
"Embodied intelligence" is a vacuous term.  Any singular intelligence 
(a _soul_ ~ do not ask me what that is in essence, for I do not know) 
has some sort of body, at least in our universe, otherwise we would not 
know about it.

So anyway, the machines cannot possible take-away human jobs.

The automation of our systems removes the need for some forms of 
human labour. [FN-3](#fn3)
But does not mean we should not still labour.  It is fun to work.  Hence 
if for no other economic reason, we should all be working.  I work even 
...
It is much more fun pursuing the puzzle than finding the solution.
...
such artistry that we are prepared to give people heaps of government 
scorepoints to continue doing such useless things. 
Yeah, but if they entertain other people then they are not _entirely_ 
...
mathematicians anyway, regardless of their output, just because it is 
fun for some.

This raises a more serious philosophical fun question: to what extent is 
...
because too may of them just do not want to to know. They seem to want 
to believe in machine superintelligence. So in many ways they are beyond 
our help. Aaronson seems to be one of them. Such a shame for such a 
smart computer scientist.

Aaronson constantly invokes the fallacy of Behaviourism. He say, "Tell 
me why what you can do a machine could not?" 
...
been greatly exaggerated. For I, for one, will continue playing 
mathematical games regardless of any extra "compute" anywhere. You cannot 
stop me!  You can just refuse to pay me government scorepoints for it. 
...
are no job losses. There is just refusal to pay wages for people to do 
gloriously mad--beautiful things.

We find it easy to pay grown men to beat each other up playing rugby. And 
even cheer about it (as I do 🤣 ... go the All Blacks!). 

There is no way the machines can reproduce what goes on in your mind 
though, there is no output there anyone can ever know about  That's the 
definition of subjective sentience. Even you do not know how you perceive 
mental qualia. So do not try telling me a machine knows either, let alone 
can even generate qualia.
...
social necessity for the labour and child exploitation, so too today 
there is no need for any unemployment to result from enhanced machine 
automation.

People need to understand the source of all unemployment. For that, you 
might try my short article: 
[“A Fermi analysis of the massive costs of unemployment”](https://doi.org/10.5281/zenodo.21450679).  Just my few 
cents worth, take it or leave it.
...
Pervert Class are also in the Political Class. There needs to be a 
separation.

Yes, yes. Eliminating class and unnecessary hierarchy also means 
eliminating the "political class". But we do better with human 
specializations, so there should always be a well-experienced civil 
...
<span id=fn1 style="font-weight: bold; margin-left: -20px">(1)&nbsp;&nbsp;&nbsp;</span>The machines are artificial something, 
but not intelligence. They may pass a Turing Test, but only because of 
heavy engineering designed to fool people. The Turing Test is a test for input/output response mimicry of ... whatever you want to mimic ... but is in no way shape or form a test for sentient intelligence. </div>


<div style="margin-left: 20px">
<span id=fn2 style="font-weight: bold; margin-left: -20px">(2)&nbsp;&nbsp;&nbsp;</span>'Unemployment' is _defined_ as people 
seeking to exchange their labour for the State's (or currency authority's) 
...
<a href="../135_fizzy_machinehead_sora_pop">Previous post</a></td>
...
<tr style="border: 1px solid color:#0f0f0f;">
<td style="border: 1px solid color:#0f0f0f;">
<a href="../135_fizzy_machinehead_sora_pop">Fizzy Machinehead Sora Pop</a></td>
<td style="border: 1px solid color:#0f0f0f; text-align:center;">
<a href="../">TOC</a></td>
<td style="border: 1px solid color:#0f0f0f; text-align:right;">
<a href="../">(TBD)</a></td>

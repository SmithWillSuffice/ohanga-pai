...
become greedy." --- That was when Stewart pointed most of the recent CPI rise is from 
price gouging. (Not actually inflation, Mr Stewart, until wages get back up.)
...
## From the "Could Note Be" $\rightarrow$ "Should Not Be" Department

MMT gives you the "could not be" reason.

---
title: "Fizzy Machinehead Sora Pop"
weight: 136
date: 2026-08-15
toc: true
draft: false
...
I almost wrote "Sora-poop."

[Here, “Can local data centre protests pop the AI Bubble”](https://www.youtube.com/shorts/1kP9Bhi1NMY) 
is a short from TheNerdReich that was prophesying a bubble collapse for 
data centre finance.  I had to be slightly contrarian, just for the 
helluvit, but also because I suspect there is something here for one or 
two readers, like  [ANGTraders](@Ang Traders ), [ProfKeen](@Steve Keen) 
and [Ghost](@GhostOnTheHalfShell) to comment upon (not to _me_!, to 
your own readers). 

> I would not bet on a bubble collapse so fast. When most funding is Federal 
(keystrokes) there is no “pop” until the Federal government turns off the 
spigot. (It is not “ tax payer funded” — it is the exact opposite, except 
this funding funds only the techbro tax evaders.) Same thing as the 2000 
NASDAQ crunch, with Clinton-Gore running a Federal surplus = non-government 
sector deficit.  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To maintain sales to pay loans the 
Valley Machineheads only need to raise their rents.  There is no need 
for the endless growth of data centres for them to profit, that dynamic is a 
floating-point-operations rate arms race among the big-tech firms. They will 
tend to eat themselves up until one or two big firms have the monopoly. 
Their bubble will thus not have collapsed.  It is a self-sustaining 
fizzy drink when Congress is backing the spend, but only the biggest 
bubbles survive, the little guys collapse. 

Be kind ... I wrote that in the minute, no second thoughts.  There may be 
nuances I am missing, bit in-the-macro I suspect this is about how things 
play out. It is a classic way so-called "disaster capitalism" works. It is 
tremendously wasteful.  You have to burn a whole lot of companies in order 
to wait for the monopolist to arise from the ashes. But is it all that far 
off the way theorists of Capitalism say things are supposed to work? Not too 
far off. Their theory will say what is left over is a whole lot of medium 
...
science, even if it proves far less efficient than solar + geothermal. 
Why? Just because is is cool. (Yeah. Yeah. Don't nerd-scold me. It is not 
cool if it diverts millions of resources away from the needs of poor 
communities, ok.)

Abundant but costly (in terms of irradiated waste and embrittlement) 
fusion energy might have a use-case outside of electricity generation, 
say in low energy physics research. Yeah, low energy!  Plasmas are much 
cooler than the collisions at the LHC. we are not going to be exploring 
Beyond the Standard Model with fusion. It is a study of the fourth state of 
matter. Which has its own beauty for those of magnetohydrodynamical bent.

But that's beside my point today. 

The relationship is one point. There is no bubble in fusion funding, 
because no one took the idea of building a friggin' star on the Earth 
too seriously.  So the number of start-ups is small.  The amount of 
fizz is low.

With algorithmic neural-nets it is different of course, because some of 
the most incredible fraudulent philosophers [FN-1](#ffn1) in history 
have lived in 
...
will end up by proxy killing?  Several million I would guess. 

The relationship is that fusion research should know no end of funding. It 
can continue on shoestrings and breadcrumbs. Slow is fine.  We do not need 
more electricity to live decent lives. We can solve the climate crisis by 
...
even happier, and less wasteful.  It is not rocket science. It is a solved 
problem that the world seems to not wish to know.  You indeed cannot 
countenance such knowledge when you measure your success against your 
rapacious next door neighbour. You need to stop using such measures.

(At least first check to see if your next door neighbour with the 
Tesla Roadster or BMW really is happy. My bet is anything that they 
think they still do not have enough government scorepoints.)


## No Bubble Fizz

I think fusion research is rather flat. Possibly in 10 years time so 
will machine algorithm fantasies of superintelligence. It is the pain we 
...
Weimar/Nazi period 
[MEFO bills](https://en.wikipedia.org/wiki/Mefo_bill), 
which funded German re-armaments, not too far in time from the Weimar 
...
A few dirtbag physicist/MMT'er talking points (thanks to Prof. Emily Bender 
for the ([un-cited, but see here](https://scholar.google.com/citations?hl=en&user=9r_f1w4AAAAJ)) academic backings):
...
the crap we have to live decent lives.  More farming robotics I say, 
but more local & organic and sustainable. (I know "organic" is a dicey 
word, but you know what I mean. Glass house agriculture is fine if 
...
<span id=fn1 style="font-weight: bold; margin-left: -20px">(1)&nbsp;&nbsp;&nbsp;</span>Their ignorance does not excuse the 
fraud, imho. Why not?  Because the whole job of the paid philosopher is 
to doubt their own theories and invite ridicule. The philosopher who 
cannot laugh at their own mad ideas is not worth reading. But every now 
and then (Gödel one of the few) they might write something true, and you 
might stay with them until you reach such gems. </div>

<div style="margin-left: 20px">
<span id=fn2 style="font-weight: bold; margin-left: -20px">(2)&nbsp;&nbsp;&nbsp;</span>None of these professional 
thinking people can hold a single photon up against Kurt Gödel. Yet, 
Gödel was honest enough to admit that there was no known reason 
a particular physical process might not become conscious-in-appearances. 
He just did not see how.  It is an escape clause from the old 
Lucas--Penrose Argument against physicalism. (Put aside the fact 
Penrose is a physicalist ... there is no accounting for taste🤣). 
Penrose only wanted to establish consciousness (whatever it is, and 
he, sagaciously, does not define it except in the negative --- what it 
is not, that is, in part, non-deterministic and mystical --- accesses 
the Platonic Realm)  ... [cough] that consciousness is not an 
algorithmic process, or does not emerge form algorithms acting upon 
matter. Thus, since to a physicalist like Penrose our brains must 
be generating the mental qualia, they must be exploiting some non-
computational processes, which Penrose mystically ascribes to "quantum 
gravity."  i say mystically because that is what it is, since no one has 
a clue what "quantum gravity" means.  But, you-know, all power to the 
mystics, I say, provided they do not trample on my beliefs like intelligensia fascists.
</div>

<div style="margin-left: 20px">
<span id=fn3 style="font-weight: bold; margin-left: -20px">(3)&nbsp;&nbsp;&nbsp;</span>It is all string emission. The SORA 
and StableDiffusion image and video is all bitstring. There is no 
mental qualia involved.  How do we know the human being is not just 
biological "string emission" emptiness, like a Dennett-head? Well, the 
whole point is (Nagel) that we do not know!  You only know of your own 
self that you are more than a bundle of atoms. You can never know this 
of any other creature. That is the point!  But you are generous and 
wise, and so attribute mind & soul to other human beings, and any other 
species capable of extraterrestrial unaided scientific development. 
Even though you have absolutely no idea what consciousness springs 
from, nor whether it is even a physical process.</div>

<div style="margin-left: 20px">
<span id=fn4 style="font-weight: bold; margin-left: -20px">(4)&nbsp;&nbsp;&nbsp;</span>Not saying mother's milk is always 
beneficial. The metaphor only goes so far.  In this case (Treasury bonds), 
it only means the baby did not need to do any real work to suckle their 
fill. Yet they still want more. Just sayin’ it is better than being 
...
<a href="../134_dont_click">Previous post</a></td>
...
<tr style="border: 1px solid color:#0f0f0f;">
<td style="border: 1px solid color:#0f0f0f;">
<a href="../134_dont_click">Don’t Click</a></td>
<td style="border: 1px solid color:#0f0f0f; text-align:center;">
<a href="../">TOC</a></td>
<td style="border: 1px solid color:#0f0f0f; text-align:right;">

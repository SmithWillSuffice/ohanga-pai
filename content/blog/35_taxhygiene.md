...
essays are worth reading, some are real snoozers though.
...
Getting a more accurate metaphor, so more like and analogy, can be 
...
The mathematician seeks to abstract and generalize.  When we do so for all the 
above types of "currency" we find taxation is the demand driver for an 
otherwise worthless IOU. What is the pure abstraction then?

> Tax is the monopoly force side of a Covenant.  
The other side of the covenant is the citizen.

This works in every case, so is the correct abstraction. The Movie Theatre is 
the monopoly provider of (for a particular local village, let's say) a
film, they tell you what you need to do to get their tickets.

In every case something is promised in redemption, which is whay the 
IOU is accepted.
...
Oe source of anxiety is an insatiable desire to "save up"the tax credits.
...
those desires, otherwise unemployment will result --- as senseless waste 
of human lives which cripples us all even if many do no feel the pain.
